...
- Determine whether unpublished packages should be a part of the index/searchable and if so this should probably be visible to the user. e.g. `unpublished` label

- What is the source for a given package. Npm, github, opam... Search page should probably link to these sources.
